    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            linkedList.AddBefore(linkedListNode1, "in");
            linkedListNode2 = linkedList.Find("Spain");
            linkedList.AddAfter(linkedListNode2, "in");

            linkedListNode1 = linkedList.Find("mainly");
            linkedList.AddBefore(linkedListNode1, "on");
            linkedListNode2 = linkedList.Find("plain");
            linkedList.AddAfter(linkedListNode2, "the");
            // 5. then call the visualizer
            VisualizeLinkedList visualizeLinkedList = new VisualizeLinkedList(linkedList);
            visualizeLinkedList.Show();
        }
