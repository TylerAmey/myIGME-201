...
namespace GIFFinder
{
    public partial class GIFFinder : Form
    {
        ...
        public GIFFinder()
        {
            ...
            this.cascadeToolStripMenuItem.Click += new EventHandler(CasccadeToolStripMenuItem_Click);
        ...
        private void CasccadeToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            if(htmlElement != null)
            {
                ...
                {
                    ImageForm imageForm = new ImageForm(this, element.GetAttribute("src"), element.GetAttribute("title"));
                    imageForm.Show();
                }
