...
namespace CourseList
{
    public partial class CourseListForm : Form
    {
        public CourseListForm()
        {
            ...
            this.courseListView.SelectedIndexChanged += new EventHandler(this.CourseListView__SelectedIndexChanged);
        ...
        public void PaintListView(string firstCourseCode)
        {
            ...
            foreach (KeyValuePair<string, Course> keyValuePair in Globals.courses.sortedList)
            {
                ...
                lvsi.Text = thisCourse.schedule.GetTime();
        ...
        private void CourseListView__ItemActivate(object sender, EventArgs e)
        {
            ...
            if (course != null)
            {
                ...
                courseDescriptionTextBox.Text = course.desription;
        ...
        private void UpdateButton__Click(object sender, EventArgs e)
        {
            ...
            copyCourse.courseDescription = courseDescriptionTextBox.Text;

            // 68. copy reviewRichTextBox into our cloned object copyCourse
            copyCourse.reviewRich = reviewRichTextBox.Text;
        ...
        {
            UpdateButton__Click(sender, e);
            CourseListView__SelectedIndexChanged(sender, e);
            CourseListView__KeyDown(sender, e);
            CourseListView__ItemActivate(sender, e);
        }
    }
}