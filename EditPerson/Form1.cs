...
namespace EditPerson
{
    public partial class PersonEditForm : Form
    {
        ...
        public PersonEditForm(Person person, Form parentForm)
        {
            ...
            this.froshRadioButton.CheckedChanged += new EventHandler(this.froshRadioButton_CheckedChanged);
            this.sophRadioButton.CheckedChanged += new EventHandler(this.sophRadioButton_CheckedChanged);
            this.juniorRadioButton.CheckedChanged += new EventHandler(this.juniorRadioButton_CheckedChanged);
            this.seniorRadioButton.CheckedChanged += new EventHandler(this.radioButton5_CheckedChanged);
            ...
            if(person.GetType() == student1.GetType())
            {
                Student student = (Student)person;
                if(student.eCollegeYear.ToString().ToLower() == "freshman")
                {
                    froshRadioButton.Checked = true;
                }
                else if (student.eCollegeYear.ToString().ToLower() == "sophomore")
                {
                    sophRadioButton.Checked = true;
                }
                else if (student.eCollegeYear.ToString().ToLower() == "junior")
                {
                    juniorRadioButton.Checked = true;
                }
                else if (student.eCollegeYear.ToString().ToLower() == "senior")
                {
        ...
        private void OkButton__Click(object sender, EventArgs e)
        {
            ...
            {
                if (radioButton == himRadioButton)
                {
                    person.eGender = genderPronoun.him;
                }
                else if (radioButton == herRadioButton)
                {
                    person.eGender = genderPronoun.her;
                }
                else if (radioButton == themRadioButton)
                {
                    person.eGender = genderPronoun.them;
                }

                if (radioButton == froshRadioButton)
                {
                    student.eCollegeYear = collegeYear.freshman;
                }
                else if (radioButton == sophRadioButton)
                {
        ...
        private void licText_TextChanged(object sender, EventArgs e)
        {
        ...
        private void froshRadioButton_CheckedChanged(object sender, EventArgs e)
        {
            ClassRadioButton__CheckedChanged(sender, e);
            OkButton__Click(sender, e);
        }

        private void sophRadioButton_CheckedChanged(object sender, EventArgs e)
        {
            ClassRadioButton__CheckedChanged(sender, e);
            OkButton__Click(sender, e);
        }
